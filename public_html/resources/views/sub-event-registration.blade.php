                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="vist-form-contain">
                                ...
                                <form action="/sub-event-register/{{ $slug }}" method="POST" id="visitorRegisterForm">
                                    @csrf
                                    ...
                                    <div class="vist-input option2">
                                        <input class="fr-rmv-str" type="number" placeholder="Your Phone" name="mobile" id="mobile"
                                            required>
                                        <span class="req-star phn">*</span>
                                    </div>
                                    <div class="vist-input option2">
                                        <input class="fr-rmv-str" type="text" name="name" placeholder="Your Name" required>
                                    ...
                                    <div class="vist-input option2">
                                        ...
                                        <select name="visit_profile" required id="prof-star-cvr">
                                            ...
                                            <option value="EPC professional / Employee">EPC professional / Employee</option>
                                             <option value="Masters Association member" style="font-weight: 600">Masters Association Member</option>
                                    ...
                                    <div class="vist-input">
                                        <input class="fr-rmv-str" type="email" placeholder="Your Email" name="email">
                                    </div>
                                    {{-- <div class="vist-input">
                                    ...
                                    <div class="vist-input">
                                        <input class="fr-rmv-str" type="text" placeholder="Enter Company Name" name="company_name"
                                            >
                                    </div>
                                    <div class="vist-input">
                                        <input class="fr-rmv-str" type="text" placeholder="Enter Your Designation" name="designation"
                                            >
                                    </div>
                                    <div class="vist-input">
                                    ...
                                    <div class="vist-input">
                                        <input class="fr-rmv-str" type="text" placeholder="District/Region" name="district" >
                                    </div>
                                    <div class="vist-input">
                                        <input class="fr-rmv-str" type="text" placeholder="State/Province" name="state" >
                                    </div>
                                    <div class="vist-input">
                                        <input class="fr-rmv-str" type="number" placeholder="Pincode/Zipcode" name="pincode" >
                                    </div>
                                    <div class="vist-input">
                                        <input class="fr-rmv-str" type="text" placeholder="Enter Landmark" name="landmark">
                                    </div>
                                    <div class="vist-input option2">
                                        {{-- <input type="text" name="visit_profile" placeholder="Visit Profile" required> --}}
                                    ...
                                    <div class="vist-input">
                                        <div style="display: flex;align-items: baseline;font-size: 14px;gap: 10px;">
                                            <input class="fr-rmv-str" type="checkbox" id="receiveupdate" name="receiveupdate"
                                                value="receiveupdate">
                ...
                if(val == 'EPC / Masters Member / System Integrator'){
                  ...
                  if(nonRequiredArray.includes(val)){
                    ...
                    $('input[name="state"]').prop('required', false).next('.req-star').remove();
                     ...
                     $('input[name="email"]').prop('required', true).after('<span class="req-star nm">*</span>');
                    $('input[name="company_name"]').prop('required', true).after('<span class="req-star nm"  style=" left: 155px;">*</span>');
                    $('input[name="designation"]').prop('required', true).after('<span class="req-star nm" style=" left: 160px;">*</span>');
                    $('input[name="address"]').prop('required', true).after('<span class="req-star nm">*</span>');
                    // $('input[name="post"]').prop('required', true).after('<span class="req-star nm" style=" left: 46px;">*</span>');
                    // $('input[name="city"]').prop('required', true).after('<span class="req-star nm" style=" left: 42px;">*</span>');
                    // $('input[name="pincode"]').prop('required', true).after('<span class="req-star nm" style=" left: 120px;">*</span>');
                    // $('input[name="landmark"]').prop('required', true).after('<span class="req-star nm" style=" left: 117px;">*</span>');
                    // $('input[name="district"]').prop('required', true).after('<span class="req-star nm" style=" left: 110px;">*</span>');
                    // $('input[name="state"]').prop('required', true).after('<span class="req-star nm" style=" left: 110px;">*</span>');
                }
            };
        });
